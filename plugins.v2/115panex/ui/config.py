...
class UIConfig:
    ...
    @staticmethod
    def get_form(hdhive_account_username: str = "", hdhive_account_points: str = "") -> Tuple[List[dict], Dict[str, Any]]:
        """
        获取插件配置表单
        ...
        hdhive_account_username = hdhive_account_username or "未读取"
        hdhive_account_points = hdhive_account_points if str(hdhive_account_points or "") else "未读取"
                ...
                'content': [
                    ...
                    # HDHive说明
                    {
                        ...
                        'content': [{
                            'component': 'VCol',
                            'props': {'cols': 12},
                            'content': [{'component': 'VAlert', 'props': {'type': 'info', 'variant': 'tonal', 'text': 'HDHive资源查询：使用已跑通的 Web/Cookie 模式，基于 TMDB ID 访问影巢详情页并提取115网盘资源。配置 Cookie，或填写用户名/密码即可。'}}]
                        }]
                    },
                    # HDHive 配置
                    {
                        ...
                        'content': [
                            ...
                            {'component': 'VCol', 'props': {'cols': 12, 'md': 4},
                             'content': [{'component': 'VTextField', 'props': {'model': 'hdhive_username', 'label': 'HDHive 用户名', 'placeholder': '可选；优先使用 Cookie'}}]},
                            {'component': 'VCol', 'props': {'cols': 12, 'md': 4},
                        ...
                        'content': [{
                            ...
                            'content': [{
                                ...
                                'content': [{
                                    'component': 'VCardText',
                                    'content': [
                                        {'component': 'div', 'props': {'class': 'text-subtitle-2 mb-2'}, 'text': 'HDHive 账号状态'},
        ...
        default_config = {
            ...
            "hdhive_account_username": "",
            "hdhive_account_points": "",
            "hdhive_username": "",
            "hdhive_password": "",
            "hdhive_cookie": "",
